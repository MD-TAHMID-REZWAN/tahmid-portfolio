    ...
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Here are some of my recent works that showcase my professional skills. I contributed to these projects through planning, structure, and design. While I didn’t code them myself, the foundation and direction were set by me.
