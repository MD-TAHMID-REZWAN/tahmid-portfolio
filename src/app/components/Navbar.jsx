        ...
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center">
            <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-xl">
              <Image
                src="/images/Cisco Badge.png" // Make sure this path is correct
                alt="Logo"
                width={48}
                height={48}
          ...
          <div className="hidden md:flex items-center space-x-6">
            {/* <div className="flex space-x-4">
              <a href="https://github.com/MD-TAHMID-REZWAN" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 transition-colors">
                <FaGithub size={20} />
              </a>
              <a href="https://www.linkedin.com/in/md-tahmid-rezwan/h" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 transition-colors">
                <FaLinkedin size={20} />
              </a>
